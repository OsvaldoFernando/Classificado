												...
												<select class="form-control select2" name="categoria_pai_id">
													...
													<?php foreach ($masters as $master): ?>
														...
														<?php if (isset($categoria)): ?>
															...
															<option value="<?php echo $master->categoria_pai_id; ?>" <?php echo($categoria->categoria_pai_id == $master->categoria_pai_id ? 'selected' : ''); ?>>
																<?php echo $master->categoria_pai_nome; ?>
															</option>

														<?php else: ?>

															<!--														Quando não estamos editando uma categoria-->
															<option value="<?php echo $master->categoria_pai_id; ?>"><?php echo $master->categoria_pai_nome; ?>
															</option>
