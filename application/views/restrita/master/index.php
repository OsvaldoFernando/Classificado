...
<!--										This is a danger alert.-->
								...
								<div class="table-responsive">
									<table class="table table-striped data-table">
										...
										<?php foreach ($masters as $master):?> <!-- masters é o que estamos enviando do nosso controlador -->
										...
										<tr>
											...
											<td><?php echo ($master->categoria_pai_ativa == 1 ? ' <div class="badge badge-success badge-shadow">Sim</div>' : ' <div class="badge badge-danger badge-shadow">Não</div>');?></td>
											...
											<td>
												...
												<a data-toggle="tooltip" data-placement="top" title="Excluír" href="<?php echo base_url('restrita/' . $this->router->fetch_class() . '/delete/' . $master->categoria_pai_id) ;?>" class="btn btn-warning delete" data-confirm="Tem certeza da exlusão do registro?"><i class="fas fa-trash"></i></a>
											</td>
										</tr>
