											...
											<div class="form-group col-md-8">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control"
														   value="<?php echo $categoria->categoria_pai_meta_link; ?>" readonly>
												</div>
											</div>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-4">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" name="categoria_pai_nome"
													   value="<?php echo(isset($categoria) ? $categoria->categoria_pai_nome : set_value('categoria_pai_nome')); ?>">
											</div>
										...
										<div class="form-group col-md-4">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control"
													   name="categoria_pai_classe_icone"
													   value="<?php echo(isset($categoria) ? $categoria->categoria_pai_classe_icone : set_value('categoria_pai_classe_icone')); ?>">
											</div>
											...
											<div class="input-group">
												...
												<select class="custom-select" name="categoria_pai_ativa">
													...
													<?php if (isset($categoria)): ?>
														...
														<option value="0" <?php echo($categoria->categoria_pai_ativa == 0 ? 'selected' : ''); ?>>
															Não
														</option>
														<option value="1" <?php echo($categoria->categoria_pai_ativa == 1 ? 'selected' : ''); ?>>
															Sim
														</option>
										...
										<?php if (isset($categoria)): ?>
											...
											<input type="hidden" name="categoria_pai_id"
												   value="<?php echo $categoria->categoria_pai_id; ?>">
										<?php endif; ?>
